...
# Import our new catalog fetchers (Sprint 2)
try:
    from simbad_fetcher import SIMBADFetcher
    SIMBAD_FETCHER_AVAILABLE = True
except ImportError:
    SIMBAD_FETCHER_AVAILABLE = False
    logger.warning("simbad_fetcher not available")

try:
    from twomass_fetcher import TwoMASSFetcher
    TWOMASS_FETCHER_AVAILABLE = True
except ImportError:
    TWOMASS_FETCHER_AVAILABLE = False
    logger.warning("twomass_fetcher not available")

try:
    from wise_fetcher import WISEFetcher
    WISE_FETCHER_AVAILABLE = True
except ImportError:
    WISE_FETCHER_AVAILABLE = False
    logger.warning("wise_fetcher not available")
...
try:
    ...
    logger.warning("cross_matcher not available")

try:
    from exoplanet_fetcher import ExoplanetFetcher
    EXOPLANET_FETCHER_AVAILABLE = True
except ImportError:
    EXOPLANET_FETCHER_AVAILABLE = False
    logger.warning("exoplanet_fetcher not available")

try:
    from ned_fetcher import NEDFetcher
    NED_FETCHER_AVAILABLE = True
except ImportError:
    NED_FETCHER_AVAILABLE = False
    logger.warning("ned_fetcher not available")

try:
    from sdss_fetcher import SDSSFetcher
    SDSS_FETCHER_AVAILABLE = True
except ImportError:
    SDSS_FETCHER_AVAILABLE = False
    logger.warning("sdss_fetcher not available")
