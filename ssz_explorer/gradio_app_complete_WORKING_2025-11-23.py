...
- **Enriched:** {stats['enriched_objects']:,} ({stats['enriched_objects']/stats['total_objects']*100:.1f}%)
- **With Temperature:** {stats['with_temperature']}
- **With Spectroscopy:** {stats['with_spectroscopy']}
