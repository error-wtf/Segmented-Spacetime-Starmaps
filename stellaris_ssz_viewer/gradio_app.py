...
# -*- coding: utf-8 -*-
"""
SSZ Stellaris Viewer - Gradio Edition
...
with gr.Blocks(title="SSZ Stellaris Viewer", theme=gr.themes.Soft()) as app:
    ...
    **Interactive 3D Visualization of Segmented Spacetime Physics with Real GAIA DR3 Data**
    ...
    - [GAIA Integration Guide](https://github.com/error-wtf/Segmented-Spacetime-Starmaps/blob/main/stellaris_ssz_viewer/GAIA_INTEGRATION.md)
    - [Quick Reference](https://github.com/error-wtf/Segmented-Spacetime-Starmaps/blob/main/stellaris_ssz_viewer/QUICK_REFERENCE.md)
