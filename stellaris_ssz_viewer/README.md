...
The **SSZ Stellaris Viewer** is a comprehensive scientific platform that enables researchers to:
...
cd Segmented-Spacetime-Starmaps/stellaris_ssz_viewer
...
- **[STELLARIS_ROADMAP.md](STELLARIS_ROADMAP.md)** - Original project roadmap
...
└── 📚 Documentation
    ...
    └── STELLARIS_ROADMAP.md            Original plan
```
...
```bibtex
@software{ssz_stellaris_viewer_2025,
  title={SSZ Stellaris Viewer: Interactive Visualization Platform for Segmented Spacetime Physics},
  author={Wrede, Carmen and Casu, Lino},
  year={2025},
  url={https://github.com/your-repo/ssz-stellaris-viewer},
...
# 3. Run
python stellaris_ssz_viewer/interactive_skymap_app.py
